...
RUN apt-get update
RUN apt-get install build-essential debhelper devscripts debian-keyring debian-archive-keyring autoconf automake cmake gettext libtool-bin locales ninja-build pkg-config unzip libtool g++ -y && apt-key update
